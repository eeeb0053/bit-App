...
public class BoardViewer {
    ...
    private void printList() {
        ArrayList<ArticleDTO> boardList = boardController.selectAll();
    ...
    private void printOne(int id) {
        ArticleDTO b= boardController.selectOne(id);
        if(b == null) {
            System.out.println();
